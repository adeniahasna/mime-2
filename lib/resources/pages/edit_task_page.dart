...
class EditTaskPage extends NyStatefulWidget {
  static RouteView path = (
    "/edit-task",
    (context) =>
        EditTaskPage(task: ModalRoute.of(context)!.settings.arguments as Task)
  );

  final Task task;

  EditTaskPage({Key? key, required this.task})
      : super(key: key, child: () => _EditTaskPageState());
}
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        for (var doc in querySnapshot.docs) {
          await doc.reference.update(updatedTask.toMap());
        }
